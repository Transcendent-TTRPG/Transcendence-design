...
- **Compatible profiles:** `Interception`, `Line Control`, `Torsion`, `Interruption`, `Impact`
...
- **Compatible profiles:** `Flow`, `Shadow Pressure`, `Rend`, `Skirmish`, `Unpredictability`
...
- **Compatible profiles:** `Perforation`, `Charge`, `Sunder`
...
- **Contact logic:** blunt committed strike through body or limb mass
- **Combat role:** collapse posture, punish contact, shock the line
- **Damage identity:** impact, disruption, force transfer
- **Compatible profiles:** `Impact`, `Charge`, `Line Control`
- **Restricted profiles:** `Precision`, `Ricochet`, `Shadow Pressure`
- **Identity notes:** Heavy forelimb forms excel at mass and collision. They are bad fits for precision or stealth-driven play.
...
- **Contact logic:** stomp, overrun, drive-through impact, or repeated body-weight strike through locomotion
- **Combat role:** pressure by advance, collapse footing, punish prone or crowded targets
- **Damage identity:** impact, anti-displacement, shock through mass and motion
- **Compatible profiles:** `Charge`, `Impact`, `Line Control`, `Sunder`
- **Restricted profiles:** `Precision`, `Torsion`, `Shadow Pressure`
- **Identity notes:** Hooves and trampling forms are about momentum and grounded force. They work well when movement itself becomes the attack, not when the fiction asks for fine control or deceptive entry.

### Wing Buffet

- **Contact logic:** broad off-line impact, gust-like spoil through massed wing motion, or balance-breaking contact from the side
- **Combat role:** disrupt approach, reposition others, destabilize clusters
- **Damage identity:** displacement, disruption, broad impact pressure
- **Compatible profiles:** `Interception`, `Line Control`, `Skirmish`, `Interruption`
- **Restricted profiles:** `Perforation`, `Sunder`, `Precision`
- **Identity notes:** Wing buffets are excellent at ruining tempo and lane control without needing deep penetration. They fit mobile spatial control far better than rigid breakthrough or exact strike profiles.
